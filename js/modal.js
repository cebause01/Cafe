...
window.openMenuModal = function openMenuModal(itemName, itemPrice, itemDescription, caffeine = null) {
    try {
        ...
        const menuImage = getMenuImage(itemName);
    ...
    modalContent.innerHTML = `
        ...
        <div class="modal-body">
            <div class="modal-image" style="background: ${menuImage ? 'none' : 'linear-gradient(135deg, #6F4E37 0%, #8B6F47 100%)'};">
                ${menuImage ? `<img src="${menuImage}" alt="${itemName}" class="bean-product-image" style="width: 100%; height: 100%; object-fit: cover;">` : ''}
            </div>
            <div class="modal-details">
                <h2>${itemName}</h2>
...
function getMenuImage(itemName) {
    const imageMap = {
        "BforBrew Favorite Latte": "images/latte.jpg",
        "Cold Brew": "images/Cold brew.jpg",
        "Cappuccino": "images/Cappuccino.jpg",
        "Americano": "images/americano.jpg",
        "Mocha": "images/mocha.jpg",
        "Espresso": "images/Espresso.jpg",
        "Chai Latte": "images/chai latte.jpg",
        "Macchiato": "images/machiatto.jpg", // Note: filename has typo (machiatto instead of macchiato)
        ...
        "Fresh Pastries": "images/fresh pastries.jpg",
        "Breakfast Sandwiches": "images/Breakfast sandwiches.jpg",
        "Avocado Toast": "images/avocado toast.jpg",
        "Quiche": "images/quicher.jpg", // Note: filename has typo
        "Bagel & Cream Cheese": "images/bagel and cream cheese.jpg",
        "Granola Bowl": "images/granola bowl.jpg",
        "Turkey & Avocado Wrap": "images/turkey and avocado wrap.jpg",
        "Veggie Panini": "images/Veggie panini.jpg",
